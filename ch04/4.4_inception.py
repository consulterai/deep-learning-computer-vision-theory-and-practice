...
from ch03.torch_utils import GET_FLOPS, VISUALISE_MODEL
...
def inceptionv4(num_classes=1000, pretrained='imagenet'):
    if pretrained:
        ...
        if pretrained == 'imagenet':
            ...
            new_last_linear.weight.data = model.last_linear.weight.data[
                                          1:]
...
if __name__ == '__main__':
    ...
    model = inceptionv4(num_classes=10, pretrained=None)
    GET_FLOPS(model, [1, 3, 224, 224])
    VISUALISE_MODEL(model, torch.randn([1, 3, 224, 224]), "inception")
